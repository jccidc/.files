...
Download the latest `.files_x64-setup.exe` from [Releases](https://github.com/200df7/.files/releases) and run it.
...
npm install
cargo tauri build
# Output: src-tauri/target/release/bundle/nsis/.files_0.1.0_x64-setup.exe
```
